...
public class RecyclerViewAdapter_Orders extends FirestoreRecyclerAdapter<Order,RecyclerViewAdapter_Orders.myViewHolder> {

    public RecyclerViewAdapter_Orders.OnItemClickListener listener;
    public RecyclerViewAdapter_Orders(@NonNull FirestoreRecyclerOptions<Order> options) { super(options); }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecyclerViewAdapter_Orders.myViewHolder(view);
    }
    ...
    public class myViewHolder extends RecyclerView.ViewHolder {
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            itemView.findViewById(R.id.processed_order).setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public void setOnItemClickListener(RecyclerViewAdapter_Orders.OnItemClickListener listener){
